[TWiki](/twiki/Main/WebHome)&gt;![](/twiki/TWiki/TWikiDocGraphics/web-bg-small.gif) [LibrePlan Web](/twiki/LibrePlan/WebHome)&gt;[Documentation](/twiki/LibrePlan/Documentation)&gt;[LibrePlanGit](http://wiki.libreplan-enterprise.com/twiki/LibrePlan/LibrePlanGit "Topic revision: 10 (01 Feb 2013 - 12:23:22)") (01 Feb 2013, [LorenzoTilve](/twiki/Main/LorenzoTilve))[Edit](http://wiki.libreplan-enterprise.com/twiki/bin/edit/LibrePlan/LibrePlanGit?t=1520337951 "Edit this topic text")[Attach](/twiki/bin/attach/LibrePlan/LibrePlanGit "Attach an image or document to this topic")
...
-   [Requirements](#Requirements)
    ...
    -   [Configuration .gitconfig](#Configuration_gitconfig)
-   [Developer profile](#Developer_profile)
    -   [Clone repository](#Clone_repository)
    -   [Create new branch](#Create_new_branch)
    -   [Commit changes](#Commit_changes)
    -   [Rebase](#Rebase)
    -   [Send patch or patches](#Send_patch_or_patches)
    -   [Working with remote branches](#Working_with_remote_branches)
-   [Reviewer profile](#Reviewer_profile)
    -   [Clone repository with write permissions](#Clone_repository_with_write_perm)
    -   [Apply patch or patches](#Apply_patch_or_patches)
    -   [Push changes](#Push_changes)
    -   [Remote branches](#Remote_branches)
        -   [Create a remote branch](#Create_a_remote_branch)
        -   [Push changes in the remote branch](#Push_changes_in_the_remote_branc)
        -   [Update remote branch with the last changes in master](#Update_remote_branch_with_the_la)
        -   [Merge remote branch into master](#Merge_remote_branch_into_master)
        -   [Deleting a remote branch](#Deleting_a_remote_branch)
-   [Git tips and tricks](#Git_tips_and_tricks)
    -   [Show branch name in prompt](#Show_branch_name_in_prompt)
    -   [Avoid trailing whitespaces and tabs mixed with spaces](#Avoid_trailing_whitespaces_and_t)
    -   [Iterative rebase](#Iterative_rebase)
...
You can check that you're in the new branch with the following command ([more info](/twiki/LibrePlan/LibrePlanGit#Show_branch_name_in_prompt)):
...
Then from local branch (which is the same than the remote one) you will create new branches to fix issues like [here](/twiki/LibrePlan/LibrePlanGit#Create_new_branch) but rebasing against `libreplan-1.2` instead of `master`.
...
In order to use this branch [see instructions below](/twiki/LibrePlan/LibrePlanGit#Working_with_remote_branches).

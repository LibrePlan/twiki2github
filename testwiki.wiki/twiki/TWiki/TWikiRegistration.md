[[TWiki|/twiki/TWikiRegistration "Attach an image or document to this topic"]]

 Registration
=============

**To edit pages on this [[TWikiSite|/twiki/TWikiSite]], you must have a registered user name and password.**

![[HELP|/twiki/ResetPassword]] their passwords.
...
(identifies you to others) [[WikiName|/twiki/WikiName]]:

`**`

(how you log in) [[LoginName|/twiki/LoginName]]:
...
-   Finish creating an account for you, so that you can start editing pages using your [[WikiName|/twiki/WikiName]].
-   Create your personal TWiki topic using your [[WikiName|/twiki/WikiName]] as topic name, and add the data you submitted to the topic.
-   Add your name to the list of users in the [[TWikiUsers|/twiki/TWikiUsers]] topic in the Main web.
-   Send you a confirmation of your registration by e-mail.

Once registered you can login using your [[LoginName|/twiki/LoginName]] and password.

-   ![info](/twiki/pub/TWiki/TWikiDocGraphics/info.gif) If you have any questions about registration, send an e-mail to [jeroen@libreplan.com](mailto:jeroen@libreplan.com?subject=TWikiRegistration%20Question).
